...
We test on following compilers GCC 10+ (up to 14), Clang 17+ (up to 21), and the latest MSVC (was tested on 19.38, 19.44). Some older compiler work too, but they become increasingly tricky to test in CI. Clang and GCC are recommended, since they're better at optimizing away the coroutine internals, with GCC being slightly behind.
